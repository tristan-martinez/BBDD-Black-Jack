...
num_enfermeros_disponible NUMBER (3),
...
cod_pokemon varchar2 (5) NOT NULL,
nombre varchar2 (20),
nivel NUMBER (3),
lugar_reside varchar2 (50)
);
...
id_entrenador varchar2 (10) NOT NULL,
id_ciudad varchar2 (10) NOT NULL,
nombre varchar2 (20),
num_medallas NUMBER (2),
num_pokemons NUMBER (8)
);
